...
public class MemberDao1 {
	...
	public int insertMember(Member member) {
		...
		int result = 0;
		PreparedStatement pstmt = null;
		String sql = "insert into member2(id, password, name, birth, zipno, address1, address2, tel1, tel2, tel3, email) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		try {
			conn = getConnection();
	...
	public int updateMember(Member member) {
		...
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql = "update member2 set name = ?, zipno = ?, address1 = ?, address2 = ?, tel1 = ?, tel2 = ?, tel3 = ?, email = ? where id = ?";
		try {
			conn = getConnection();
			pstmt = conn.prepareStatement(sql);
			int i = 0;
