  ...
  <body>
	...
	<form action="sub_writePro.do" method="post" onsubmit="return chk()"
		...
		<table border="1" width="650" cellpadding="0" cellspacing="2"
			...
			<tr>
				<th>글내용</th>
				<td colspan="3" class="left"><textarea rows="15" cols="50" disabled="disabled">${board.content }</textarea></td>
			</tr>
			<tr>
				<th>댓글</th>
				<td colspan="3">
					...
					<table border="0">
						...
						<c:if test="${total>0 }">
						<tr>
						<th>순번</th><th>작성자</th><th>내용</th></tr>
						...
						<tr>
							<td><input type="text" name="sub_writer"></td>
							<td><input type="text" name="sub_content"></td>
							<td><input type="text" name="sub_password"></td>
