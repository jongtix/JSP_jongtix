  		...
  		<div class="container-fluid">
  			<div class="navbar-header">
  				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
  					...
  					<span class="icon-bar"></span> <!-- 게시판 갯수 -->
  					<span class="icon-bar"></span>
  					<span class="icon-bar"></span>
  				</button>
  				<a class="navbar-brand" href="main.do"><img style="height:40px;" src="${pageContext.request.contextPath}/module/logo.jpg" alt="로고"></a>
  			</div>
  			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  				<ul class="nav navbar-nav">
  					<li><a href="main.do">메인화면<span class="sr-only"></span></a></li>
  				...
  				<form class="navbar-form navbar-left" action="searchPro.do" method="post">
  					<div class="form-group">
  						<input type="text" class="form-control" name="search" placeholder="내용을 입력하세요.">
  					</div>
  				...
  				<ul class="nav navbar-nav navbar-right">
  					...
  					<c:if test="${!empty id}">
  						...
  						<ul class="dropdown-menu">
  							<li><a href="updateform.do">회원정보 보기</a></li>
