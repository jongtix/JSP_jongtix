  ...
  <body>
	...
	<input type="hidden" name="num" value="${board.num }"><input
		...
		<table border="1" width="650" cellpadding="0" cellspacing="2"
			...
			<tr>
				<th>수량</th>
				<td ><input type = "text" name = "rent_count"></td>
			</tr>
			<tr>
				<th>구매자</th>
				<td><input type = "text" name = "rent_buyer"></td>
				</tr>
				<tr>
				<th>수령자</th>
			...
			<tr>
			<td colspan="2" align = "center"><input type = "submit"  value = "확인"> <input type="button" value="글목록"
