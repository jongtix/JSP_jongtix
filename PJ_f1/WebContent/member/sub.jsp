	...
	<form action="subpro.do" method="post" onsubmit="return chk2()">
		<fieldset style="width:400px;">
			...
			<table>
				<tr>
					<td>ID</td>
					<td><input type="text" id="id" name="id" maxlength="20"> <input
						type="button" name="id2" id="id2" value="중복확인" onclick="return chk3()"></td>
				</tr>
				<tr>
					<td>PW</td>
				...
				<tr>
					<td>PW확인</td>
					<td><input type="password" id="password2" name="password2" maxlength="20">
					</td>
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>주민번호</td>
					<td><input type="text" id="rrnum1" name="rrnum1" size="8" maxlength="6">
						- <input type="password" id="rrnum2" size="8" name="rrnum2" maxlength="7"></td>
				</tr>
				<tr>
					<td>우편번호</td>
