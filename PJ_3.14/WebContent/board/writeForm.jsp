...
<form action="writePro.do" method="post" enctype="multipart/form-data">
		...
		<table class="table">
			...
			<tr>
				<th>비밀번호 확인</th>
				<td><input type="password" class="form-control" name="password2"required="required"></td>
			</tr>
			<tr>
				<th>분류선택</th>
			...
			<tr>
				<th>수량</th>
				<td><input type="text" class="form-control" name="item_count"required="required"></td>
			</tr>
			<tr>
				<th>이미지</th>
