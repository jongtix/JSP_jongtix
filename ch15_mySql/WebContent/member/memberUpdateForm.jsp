...
<%
	...
	if (id == null || id.equals("")) {
		...
		String tel1 = tel.substring(0, tel.indexOf('-')).trim();
		String tel2 = tel.substring(tel.indexOf('-') + 1, tel.lastIndexOf('-')).trim();
		String tel3 = tel.substring(tel.lastIndexOf('-') + 1).trim();
...
<body>
	<form action="memberUpdateProc.jsp" onsubmit="return chk()" name="frm"
		method="post">
		<table border=1 bgcolor="yellow">
			...
			<tr>
				...
				<td><input type="text" name="zipno" id="zipno" maxlength="7"
					size="7" value="${member.zipno}" required> <input
					type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br></td>
			</tr>
			<tr>
				<td>*주소1</td>
				<td><input type="text" name="address1" id="address1"
					maxlength="80" size="80" value="${member.address1}"> <span
			...
			<tr>
				...
				<td><input type="text" name="address2" id="address2"
					maxlength="50" size="50" value="${member.address2}"></td>
			</tr>
			<tr>
				<td>tel</td>
				<td><select name="tel1" id="tel1">
					...
					value="${tel2}"> - <input type="text" name="tel3" id="tel3"
					size="4" maxlength="4" value="${tel3}"></td>
			</tr>
			<tr>
				<td>*email</td>
				<td><input type="text" name="emailId" id="emailId"
					value="${emailId}"> @ <input type="text" name="email2"
					id="email2" value="${emailDomain}"> <select
